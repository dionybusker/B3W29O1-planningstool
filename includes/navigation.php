<div class="container col-8 mx-auto border bg-white">
    <div class="row navbar navbar-expand mb-3">
        <div class="col-5">
            <h1>Spelletjesdag</h1>
        </div>
        ...
        <div class="col-7">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mx-2"><a class="nav-link btn btn-outline-dark" href="all-plannings.php">Geplande spellen</a></li>
